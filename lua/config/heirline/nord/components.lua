...
local dim_color = palette.light_gray_bright
...
M.Mode = {
  ...
  hl = function(self)
    ...
    return { fg = palette.black, bg = self.mode_colors[mode], bold = true }
  end,
  update = {
    'ModeChanged',
    pattern = '*:*',
...
M.MacroRecording = {
  ...
  end,
  {
    ...
    hl = { fg = palette.darkest_white, bg = palette.black },
  },
...
M.FilePath = {
  ...
  hl = function(self)
    return {
      fg = self.is_active and palette.darkest_white or palette.light_gray,

...
vim.fn.sign_define('DapBreakpoint', { text = '', texthl = 'DapUIBreakpointsCurrentLine', linehl = '', numhl = 'DapUIBreakpointsCurrentLine' })
vim.fn.sign_define(
  'DapBreakpointCondition',
  { text = '', texthl = 'DapBreakpointCondition', linehl = 'DapBreakpointCondition', numhl = 'DapBreakpointCondition' }
)
vim.fn.sign_define('DapUIStopped', { text = '', texthl = 'DapStopped', linehl = 'DapStopped', numhl = 'DapStopped' })
